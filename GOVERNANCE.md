...
ASAP is designed as an **open protocol** with a **single canonical origin**.
...
Any implementation claiming ASAP compatibility **MUST** reference this repository.

---

## Registry Governance

ASAP allows multiple registries. However:

- Only registries that adhere to this specification may claim compatibility.  
